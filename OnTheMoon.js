var config = {
    ...
    modifyBetEvery: { value: 5, type: 'text', label: 'Modify bet every x games' },
    maxBetOrMaxDeficit: {
...
var isBetting = false;
var userProfit = 0;
var gamesWithoutMultiplier = GetGamesWithoutX(multiplier) + 1; //+1 is to start to 1 instead of 0
var bettedGames = 0;
...
engine.on('GAME_ENDED', function () {
    ...
    if (isBetting) {
        if (!gameInfos.cashedAt) {
            ...
            if (bettedGames % modifyBetEvery == 0) {
